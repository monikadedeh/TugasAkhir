...
class ProfiluserController extends Controller
{
    ...
    public function updatePassword(Request $request, $id)
    {
        ...
        if ($newPassword === $request->confirmPassword) {
            ...
            return redirect()->route('user.update.password')->with("editpw", "Berhasil Ganti Password");
        } else {
           return redirect()->route('user.update.password')->with("failedpw", "Gagal Ganti Password");
        }
    }
}
