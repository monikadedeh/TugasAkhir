                ...
                <div class="col-md-4 col-12 float-left">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <img src="{{url('foto-guru/'. $editprofil->foto)}}" style="width:200px; height:200px;" alt="Photo" srcset="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-8 col-12 float-right">
                    <div class="card">
                            <div class="card-body">
                                <h3>Data Diri</h3>
                                <hr>
                                <form class="form form-horizontal" action="{{route('profil.guru.simpan', $editprofil->id)}}" method="post" enctype="multipart/form-data" >
                                    @method('patch')
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="text" id="Nama" class="form-control"
                                                    name="nama_guru" value="{{$editprofil->nama_guru}}" placeholder="Masukan Nama Anda">
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="email" id="Email" class="form-control"
                                                    name="email_guru" value="{{$editprofil->email_guru}}" placeholder="Masukan Email Anda">
                                            </div>
                                            <div class="col-md-4">
                                                <label>Foto</label>
                                            </div>
